...
description: "매수와 매도 뜻, 주식 거래의 기본을 초보자도 이해할 수 있게 그림과 표로 설명합니다."
analysis_type: "concept"
review_status: "needs_review"
search_intent: "주식 매매 방법 이해"
primary_keyword: "매수와 매도"
---

# 매수와 매도 뜻, 주식 거래의 기본

주식을 처음 시작하면 "매수", "매도"라는 단어가 어색합니다. 그냥 "사다", "팔다"인데 왜 어려운 용어를 쓸까요?

매수와 매도는 주식 거래의 가장 기본적인 행위이며, 이 두 단어를 정확히 이해하면 모든 거래가 편해집니다.
...
- 기업 가치를 정확히 판단할수록 매수·매도 타이밍의 정확도가 높아집니다.
