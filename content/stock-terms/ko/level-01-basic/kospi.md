...
_코스피 지수는 시가총액 가중 방식이라 대형주의 움직임이 지수에 큰 영향을 줍니다._
...
- 2020년 3월 (코로나 저점): 약 1,450 → 기준 대비 14.5배
- 2021년 6월 (고점): 약 3,300 → 기준 대비 33배
...
| 대표 기업 | 삼성전자, 현대차, SK하이닉스 | 에코프로, 셀트리온헬스케어 |
...
- 코스피 전체 PER이 역사적으로 어디쯤인가? (저평가 구간인가, 고평가 구간인가)
...
- 코스피 전체 PER과 개별 종목 PER을 비교하면 상대적 고평가·저평가를 판단할 수 있습니다.
- 코스피가 급락할 때 내 종목의 방어력(베타)을 확인할 수 있습니다.
- 시장 전체가 저평가 구간이면 개별 종목도 함께 저평가되었을 가능성이 있습니다.
